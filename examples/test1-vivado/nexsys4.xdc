...
set_property PACKAGE_PIN E16 [get_ports btnc_in]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnc_in]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports btnu_in]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnu_in]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports btnl_in]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnl_in]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports btnr_in]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnr_in]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports btnd_in]						
...
##Bank = 35, Pin name = IO_L9P_T1_DQS_AD7P_35,				Sch name = SD_SCK / SPI - SCLK
set_property PACKAGE_PIN B1 [get_ports sclk]						
	set_property IOSTANDARD LVCMOS33 [get_ports sclk]
##Bank = 35, Pin name = IO_L16N_T2_35,						Sch name = SD_CMD / SPI - MOSI
set_property PACKAGE_PIN C1 [get_ports mosi]						
	set_property IOSTANDARD LVCMOS33 [get_ports mosi]
##Bank = 35, Pin name = IO_L16P_T2_35,						Sch name = SD_DAT0 / SPI - MISO
...
##Bank = 35, Pin name = IO_L14N_T2_SRCC_35,					Sch name = SD_DAT3 / SPI - SS
